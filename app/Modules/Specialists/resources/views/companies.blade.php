...
<div class="modal fade" id="link-companies" tabindex="-1" role="dialog" aria-labelledby="link-companies" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="/specialists/{{ $record->id }}/companies" method="post">
                @csrf

                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="fa fa-plus"></i> Adicionar <em>{{ $record->name }}</em> a empresas</h5>
                    <div class="close">
                        <input class="form-control-sm" type="text" id="search-input" onkeyup="search()" placeholder="Search...">
                        <a class="modal-close" href="/specialists">
                ...
                <div class="modal-footer">
                    <div class="form-group form-actions">
                        <a href="/specialists" class="btn btn-secondary">Cancelar</a>
